...
namespace Landlords.Migrations
{
    ...
    [Migration("20170801150051_AddedConversations")]
    partial class AddedConversations
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Model.Entities.Conversation", b =>
                {
                    b.HasOne("Model.Database.ApplicationUser", "Landlord")
                        .WithMany()
                        .HasForeignKey("LandlordId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Model.Database.ApplicationUser", "Tenant")
                        .WithMany()
            ...
            modelBuilder.Entity("Model.Entities.ConversationMessage", b =>
                {
                    ...
                    b.HasOne("Model.Database.ApplicationUser", "From")
                        .WithMany()
