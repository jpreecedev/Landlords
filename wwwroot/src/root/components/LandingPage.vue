<template>
  <main>
    <div class="jumbotron">
      <div class="container">
        <h1 class="md-display-4">Hello, landlords!</h1>
        ...
        <p><v-btn @click.native="$router.push({name: 'registration'})" role="button">Go to registration &raquo;</v-btn></p>
      </div>
    </div>
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4">
          ...
          <h2 class="md-display-1">Heading</h2>
