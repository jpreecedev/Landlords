      ...
      <form @submit.prevent="validateBeforeSubmit" role="form" novalidate>
        <fieldset>
          <div class="form-group row" :class="{ 'has-danger': errors.has('firstName') }">
            ...
            <div class="col-9">
              <input v-model="newUser.firstName" class="form-control" id="firstName" name="firstName" type="text" placeholder="Your first name" v-validate="'required'" data-vv-validate-on="blur" required>
          ...
          <div class="form-group row" :class="{ 'has-danger': errors.has('lastName') }">
            ...
            <div class="col-9">
              <input v-model="newUser.lastName" id="lastName" name="lastName" type="text" placeholder="Your last name" class="form-control" v-validate="'required'" data-vv-validate-on="blur" required>
          ...
          <div class="form-group row" :class="{ 'has-danger': errors.has('emailAddress') }">
            ...
            <div class="col-9">
              <input v-model="newUser.emailAddress" id="emailAddress" name="emailAddress" type="text" placeholder="you@email.com" class="form-control" v-validate="'required|email'" data-vv-validate-on="blur" required>
          ...
          <div class="form-group row" :class="{ 'has-danger': errors.has('password') }">
            ...
            <div class="col-9">
              <input v-model="newUser.password" id="password" name="password" type="password" placeholder="Enter your password" class="form-control" v-validate="'required|min:8|confirmed:repeatPassword'" data-vv-validate-on="blur" required>
          ...
          <div class="form-group row" :class="{ 'has-danger': errors.has('password') }">
            ...
            <div class="col-9">
              <input id="repeatPassword" name="repeatPassword" type="password" placeholder="Repeat your password" v-validate="'required'" v-model="newUser.repeatPassword" data-vv-as="password confirmation" data-vv-validate-on="blur" class="form-control">
